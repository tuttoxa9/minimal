...
const translations = {
  en: {
    ...
    "add.offplan": "Off-plan",
    "add.secondary": "Secondary",
    "add.rent": "Rent",
    "add.unspecified": "Unspecified",
    "add.comment": "Comment",
    "add.messenger_label": "Messenger",
    "add.budget_label": "Budget",
    "add.goal_label": "Goal",
    "add.creative_label": "Creative",
    "add.offer_label": "Offer",
    // Drawer
    ...
    "drawer.messenger": "Messenger",
    "drawer.budget": "Budget",
    "drawer.goal": "Goal",
    "drawer.creative": "Creative",
    "drawer.offer": "Offer",
  ...
  ru: {
    ...
    "add.offplan": "Новостройки",
    "add.secondary": "Вторичка",
    "add.rent": "Аренда",
    "add.unspecified": "Не указан",
    "add.comment": "Комментарий",
    "add.messenger_label": "Мессенджер",
    "add.budget_label": "Бюджет",
    "add.goal_label": "Цель покупки",
    "add.creative_label": "Креатив",
    "add.offer_label": "Оффер",
    // Drawer
    ...
    "drawer.messenger": "Мессенджер",
    "drawer.budget": "Бюджет",
    "drawer.goal": "Цель покупки",
    "drawer.creative": "Креатив",
    "drawer.offer": "Оффер",
